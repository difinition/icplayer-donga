    ...
    presenter.setState = function(state) {
        ...
        if (wasTextEditionMode) {
            if (parsedState.textEditorResult) {
                parsedState.textEditorResult = JSON.parse(parsedState.textEditorResult);
                try{
                    parsedState.textEditorResult.brokenText = JSON.parse(parsedState.textEditorResult.brokenText);
                }catch(e){};
